...
VALID_LOGOFF = 1
modelS_MIN_PASSWD_LEN_PARMNUM = 1
modelS_MAX_PASSWD_AGE_PARMNUM = 2
modelS_MIN_PASSWD_AGE_PARMNUM = 3
modelS_FORCE_LOGOFF_PARMNUM = 4
modelS_PASSWD_HIST_LEN_PARMNUM = 5
modelS_ROLE_PARMNUM = 6
modelS_PRIMARY_PARMNUM = 7
modelS_DOMAIN_NAME_PARMNUM = 8
modelS_DOMAIN_ID_PARMNUM = 9
modelS_LOCKOUT_DURATION_PARMNUM = 10
modelS_LOCKOUT_OBSERVATION_WINDOW_PARMNUM = 11
modelS_LOCKOUT_THRESHOLD_PARMNUM = 12
modelS_MIN_PASSWD_LEN_INFOLEVEL = PARMNUM_BASE_INFOLEVEL + modelS_MIN_PASSWD_LEN_PARMNUM
modelS_MAX_PASSWD_AGE_INFOLEVEL = PARMNUM_BASE_INFOLEVEL + modelS_MAX_PASSWD_AGE_PARMNUM
modelS_MIN_PASSWD_AGE_INFOLEVEL = PARMNUM_BASE_INFOLEVEL + modelS_MIN_PASSWD_AGE_PARMNUM
modelS_FORCE_LOGOFF_INFOLEVEL = PARMNUM_BASE_INFOLEVEL + modelS_FORCE_LOGOFF_PARMNUM
modelS_PASSWD_HIST_LEN_INFOLEVEL = (
    PARMNUM_BASE_INFOLEVEL + modelS_PASSWD_HIST_LEN_PARMNUM
)
modelS_ROLE_INFOLEVEL = PARMNUM_BASE_INFOLEVEL + modelS_ROLE_PARMNUM
modelS_PRIMARY_INFOLEVEL = PARMNUM_BASE_INFOLEVEL + modelS_PRIMARY_PARMNUM
modelS_DOMAIN_NAME_INFOLEVEL = PARMNUM_BASE_INFOLEVEL + modelS_DOMAIN_NAME_PARMNUM
modelS_DOMAIN_ID_INFOLEVEL = PARMNUM_BASE_INFOLEVEL + modelS_DOMAIN_ID_PARMNUM
GROUPIDMASK = 32768
GROUP_ALL_PARMNUM = 0
