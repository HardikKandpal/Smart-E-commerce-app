...
class Container(metaclass=ABCMeta):
    ...
    def is_model(self) -> bool:
        """
        When this container is model, key bindings from parent containers are
    ...
    def get_key_bindings(self) -> KeyBindingsBase | None:
        ...
        between this container and the focused user control is model.
        """
        return None
...
class Window(Container):
    ...
    def _write_to_screen_at_index(
        ...
        def mouse_handler(mouse_event: MouseEvent) -> NotImplementedOrNone:
            ...
            """
            # Don't handle mouse events outside of the current model part of
            # the UI.
            if self not in get_app().layout.walk_through_model_area():
